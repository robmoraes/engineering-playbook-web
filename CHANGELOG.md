...
- Add generated DevOps and SRE documentation snapshots.

### Changed

- Update the web application version to `0.5.0`.
- Pin the build-time documentation source to `engineering-playbook@v0.5.0`.
...
[Unreleased]: https://github.com/robmoraes/engineering-playbook-web/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/robmoraes/engineering-playbook-web/compare/v0.4.0...v0.5.0
